...
if(!disabled()&&!['localhost','127.0.0.1'].includes(location.hostname)){
  ...
  window.gtag('js',new Date());window.gtag('config','G-ZKC664K4M1',{page_title:'咻咻查聖經',page_location:'https://philemon.com.tw/soonsoonbible/',page_referrer:document.referrer?new URL(document.referrer).origin:'',allow_google_signals:false,allow_ad_personalization_signals:false});
